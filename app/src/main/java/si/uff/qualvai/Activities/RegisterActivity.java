...
public class RegisterActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setupActionBar();
        mCoordinatorLayout = (CoordinatorLayout) findViewById(R.id.registerCoordinatorLayout);
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            mFirebaseRef.createUser(mEmail, mPassword, new Firebase.ValueResultHandler<Map<String, Object>>() {
                ...
                public void onSuccess(Map<String, Object> result) {
                    ...
                    mFirebaseRef.child("users").child(result.get("uid").toString()).setValue(true);
                ...
                public void onError(FirebaseError firebaseError) {
                    ...
                    Snackbar snackbar = Snackbar
                            .make(mCoordinatorLayout, firebaseError.toString(), Snackbar.LENGTH_LONG);
        ...
        protected void loginAfterSignUp() {
            mFirebaseRef.authWithPassword(mEmail, mPassword, new Firebase.AuthResultHandler() {
                ...
                public void onAuthenticated(AuthData authData) {
                    ...
                    Intent intent = new Intent(RegisterActivity.this, SelectDateActivity.class);
            ...
            handler.postDelayed(new Runnable() {
                public void run() {
                    ...
                    if(mFirebaseRef.getAuth() != null) {
                        ...
                        settings.edit().putBoolean(mFirebaseRef.getAuth().getUid() + getString(R.string.is_profile_info_complete), false).apply();
                        Log.v("Login", "Uid" + mFirebaseRef.getAuth().getUid());
                        intent = new Intent(RegisterActivity.this, SelectDateActivity.class);
